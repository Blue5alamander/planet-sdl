...
namespace {
    ...
    auto const gh = felspar::testsuite(
            "gravity/horizontal",
            [](auto check) {
                auto const v = planet::sdl::ui::within({}, unitbox, unit);
                check(v.left()) == 0;
                check(v.top()) == 0;
                check(v.right()) == 1;
                check(v.bottom()) == 1;
            ...
            [](auto check) {
                auto const v = planet::sdl::ui::within({}, testbox, unit);
                check(v.left()) == 2;
                check(v.top()) == 3;
                check(v.right()) == 6;
                check(v.bottom()) == 8;
            ...
            [](auto check) {
                auto const v = planet::sdl::ui::within(
                        planet::sdl::ui::gravity::left, testbox, unit);
                check(v.left()) == 2;
                check(v.top()) == 3;
                check(v.right()) == 3;
                check(v.bottom()) == 8;
            ...
            [](auto check) {
                auto const v = planet::sdl::ui::within(
                        planet::sdl::ui::gravity::right, testbox, unit);
                check(v.left()) == 5;
                check(v.top()) == 3;
                check(v.right()) == 6;
                check(v.bottom()) == 8;
    ...
    auto const gv = felspar::testsuite(
            ...
            [](auto check) {
                auto const v = planet::sdl::ui::within(
                        planet::sdl::ui::gravity::top, testbox, unit);
                check(v.left()) == 2;
                check(v.top()) == 3;
                check(v.right()) == 6;
                check(v.bottom()) == 4;
            ...
            [](auto check) {
                auto const v = planet::sdl::ui::within(
                        planet::sdl::ui::gravity::bottom, testbox, unit);
                check(v.left()) == 2;
                check(v.top()) == 7;
                check(v.right()) == 6;
                check(v.bottom()) == 8;
